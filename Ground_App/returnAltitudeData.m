function [output] = returnAltitudeData()
    ...
    AltituderowIndex = 3;  % Replace with the desired row index
    AltitudecolumnIndex = 2;  % Replace with the desired column index

    % Get the data from the specified row and column
    desiredData = data(AltituderowIndex,AltitudecolumnIndex);
    output = desiredData;
end
