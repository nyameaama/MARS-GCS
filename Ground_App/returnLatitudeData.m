function [output] = returnLatitudeData()
    ...
    LatituderowIndex = 5;  % Replace with the desired row index
    LatitudecolumnIndex = 2;  % Replace with the desired column index

    % Get the data from the specified row and column
    desiredData = data(LatituderowIndex,LatitudecolumnIndex);
    output = desiredData;
end
