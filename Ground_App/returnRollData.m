function [output] = returnRollData()
    ...
    RollrowIndex = 8;  % Replace with the desired row index
    RollcolumnIndex = 2;  % Replace with the desired column index

    % Get the data from the specified row and column
    desiredData = data(RollrowIndex,RollcolumnIndex);
    output = desiredData;
end
